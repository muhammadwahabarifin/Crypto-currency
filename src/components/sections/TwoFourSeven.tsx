    ...
    return (
        <section className="flex justify-between flex-col md:flex-row gap-8 items-center xl:-mt-[30rem]">
            ...
            <div className="mt-4 px-4 md:px-[130px]">
                ...
                <p className="text-subtitle font-semibold mt-4 mb-[32px]">
                ...
                <div>
                    <MainButton
                        text="Get Started"
                        classes="bg-transparent  hover:bg-transparent border-[2px] border-white rounded-[10px] font-semibold w-[156px] h-[56px]" disabled={false} />
                </div>
            </div>
        </section>
    );
