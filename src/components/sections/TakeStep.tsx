...
export default function TakeStepSection() {
    return (
        <section className='z-10 relative flex justify-between flex-col md:flex-row gap-8 items-center xl:-mt-[30rem]'>
            <div className='mt-4 px-4 md:px[130px]'>
                <motion.p
                    ...
                    viewport={{ once: false }}
                    className='text-3xl md:text-[50px] font-bold'
                >
                ...
                <motion.p
                    ...
                    viewport={{ once: false }}
                    className='text-subtitle font-semibold mt-4 mb-[32px]'
                >
                ...
                >
                    <MainButton
                        text='Get Started'
                        classes='bg-transparent primary-gradient  hover:bg-transparent rounded-[10px] font-semibold w-[156px] h-[56px]' disabled={false}
                    />
                </motion.div>
            </div>
            <motion.div
